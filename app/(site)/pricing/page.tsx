    ...
    <div className="h-full bg-slate-50 text-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 pt-24">
        <div className="text-center mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl  tracking-tight text-slate-900 mb-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/signup" className="inline-flex items-center justify-center rounded bg-blue-600 px-6 py-3 text-sm  text-white hover:bg-blue-700 transition-colors">
              Start free trial
            </Link>
            <Link href="/contact" className="inline-flex items-center justify-center rounded border border-slate-200 bg-white px-6 py-3 text-sm  text-slate-700 hover:bg-slate-100 transition-colors">
              Contact sales
            </Link>
          </div>
        </div>
          ...
          {tiers.map((tier) => (
            <div key={tier.name} className={`rounded border ${tier.featured ? 'border-blue-200 bg-white' : 'border-slate-200 bg-white'} p-8`}>
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-sm  uppercase tracking-[.24em] text-slate-500">{tier.badge}</p>
                  <h2 className="mt-4 text-2xl  text-slate-900">{tier.name}</h2>
                </div>
                {tier.featured && (
                  <div className="rounded bg-blue-600 px-3 py-1 text-xs  text-white">Popular</div>
                )}
              </div>
              <p className="mt-6 text-4xl  tracking-tight text-slate-900">{tier.price}</p>
              ...
              <Link href="/signup" className="mt-8 inline-flex w-full items-center justify-center rounded bg-blue-600 px-4 py-3 text-sm  text-white hover:bg-blue-700 transition-colors">
                Choose plan
              </Link>
            </div>
          ))}
        ...
        <section className="mt-20 bg-white rounded border border-slate-200 p-8 ">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm  uppercase tracking-[.24em] text-blue-600">Comparison</p>
              <h2 className="mt-3 text-3xl  text-slate-900">Choose the plan that fits your classroom.</h2>
            </div>
        ...
        <section className="mt-20">
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-3 text-xl bg-blue-100  text-blue-700 w-fit">
               
                Frequently asked questions
              </div>
              <h2 className="text-3xl  text-slate-900">Everything you need to know before you choose.</h2>
